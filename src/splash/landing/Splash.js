          ...
          <div className="grey-screen pb5 pb6-m pb6-l">
            ...
            <div className="tc-l pt6 ph3">
              <h1 className="f1 f1-m lh-title mv0">
                <span className="lh-copy white pa1 tracked-tight">Manage Your Democracy</span>
              </h1>
              <h3 className="fw1 f5 theme-blue mt3 mb4">Legislation and communication built on nano-blockchains</h3>
              <h2 className="fw1 f3 white-80 mt3 mb4">Athares lets you create and maintain organizations with equality.</h2>
