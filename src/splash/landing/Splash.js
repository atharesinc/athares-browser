                ...
                <div>
                    <h1 className='f2 f1-ns f1-m lh-title mv0'>
                        <span className='lh-copy white pa1 tracked-tight'>
                            Better foundations for better organizations
                        </span>
                    </h1>
                    <h2 className='fw1 f5 theme-blue mt3 mb4'>
                        Athares lets you participate in governments and
                        organizations directly, secured with distributed
                        technology.
                    </h2>
                    <div className='tc ph0 ph3-ns'>
