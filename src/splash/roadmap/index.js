        ...
        <div id="roadmap-wrapper" className="splash">
          ...
          <div className="w-100 bg-white black dib pb5 bb b--white-50 ph3 ph5-ns pt5">
            <p className="fl w-100 w-50-l mh0 mt0 pr0 pr3-l measure lh-copy f5 f5-l">
              ...
              servers, communicating over stellar distances, and working towards
              a sustainable and free multi-planetary utopia. Privatizing space
              exploration, while presenting incredible possibilities, has the
              side effect of astronomical problems. The question of "who decides
              what" in a burgeoning colony warrants immediate attention.
            </p>
            <p className="fl w-100 w-50-l mh0 mt0 pl0 pl3-l measure lh-copy f5 f5-l">
              ...
              established order enables us to build our societies right the
              first time. We can build an economy that is a sharing economy by
              default, with lightning fast and a truly distributed banking
              system. It's a society eager to participate in public debate being
              so equipped with equal access to unbiased information, that can
