    ...
    >
      {user ? (
        ...
        >
          ...
          <div className="dtc v-mid pl3">
            ...
            <h2 className="f6 f7-ns fw4 mt0 mb0 white-60">View Profile</h2>
          </div>
        </Link>
      ) : (
        <Link
        ...
        >
          ...
          <div className="dtc v-mid pl3">
            ...
            <h2 className="f6 f7-ns fw4 mt0 mb0 white-60">Click to log in</h2>
          </div>
        </Link>
      )}
      {/* Sub menu */}
      ...
      <ul className="list pl0 mt0 measure center">
        ...
        <Link
          ...
          to="policy"
        >
          <FeatherIcon className="w2 h2 w3-ns h3-ns pa3-ns pa0" icon="info" />
