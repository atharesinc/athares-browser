...
const ViewUser = (props) => {
  ...
  if (loading) {
    return (
      <div id="dashboard-wrapper" style={{ justifyContent: 'center' }}>
        <Loader />
      </div>
    );
  }
  ...
  return (
    <div id="dashboard-wrapper" style={{ width: 'inherit' }} autoHide autoHideTimeout={1000} autoHideDuration={200} universal={true}>
      <div className="particles-bg w-100 vignette shaded">
        <header className="tc pv2 pv4-ns" style={{ height: '12em' }}>
          <div className="w-100 row-center" style={{ justifyContent: 'space-between' }}>
            <Link className="f6 link dim br-pill ba bw1 ph3 pv2 mh2 mh4-ns dib white" to="/app">
              BACK
            </Link>
            <Link className="f6 link dim br-pill ba bw1 ph3 pv2 mh2 mh4-ns dib white" to="/app/user/edit">
              EDIT
            </Link>
          </div>
      ...
      <ul className="list ph2 ph4-ns pv2 ma2 w-100 center">
        ...
        <li className="flex items-center lh-copy pa3 ph0-l bb b--white-30">
          ...
          <div>
            <div className="f6 link white-70">{User.phone || 'Not set'}</div>
          </div>
        </li>
        <li className="flex items-center lh-copy pa3 ph0-l bb b--white-30">
          ...
          <div>
            <div className="f6 link white-70">{User.email || 'Not set'}</div>
          </div>
        </li>
        <li className="flex items-center lh-copy pa3 ph0-l bb b--white-30">
          ...
          <div>
            <div className="f6 link white-70">{User.uname || 'Not set'}</div>
          </div>
        </li>
      </ul>
      {/* Fat Stats */}
      <article className="ph2 ph4-ns pv2" data-name="slab-stat">
        ...
        <dl className="dib mr5">
          ...
          <dd className="f4 f3-ns b ml0">{moment(User.createdAt).format('M/D/YY')}</dd>
        </dl>
      </article>
    </div>
  );
